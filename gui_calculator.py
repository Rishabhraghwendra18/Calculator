...
button_add=t.Button(root,text="+",padx=30,pady=50,width=2,borderwidth=3)
button_sub=t.Button(root,text="-",padx=50,pady=20,borderwidth=3)
button_mult=t.Button(root,text="X",padx=50,pady=20,borderwidth=3)
button_div=t.Button(root,text="/",padx=50,pady=20,borderwidth=3)
